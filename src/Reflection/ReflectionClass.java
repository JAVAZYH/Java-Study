...
import Reflection.Entity.Student;
...
//        clazz=obj.getClass();
        String className="Reflection.Entity.Student";
...
public void testClassLoader() throws ClassNotFoundException {
    ...
    classLoader=Class.forName(  "Reflection.Entity.Student").getClassLoader();
    System.out.println(classLoader);
    //测试object的类加载器，引导类
...
public void testClassLoader2(){
    InputStream in=null;
    in=this.getClass().getClassLoader().getResourceAsStream( "Reflection/test.txt" );
