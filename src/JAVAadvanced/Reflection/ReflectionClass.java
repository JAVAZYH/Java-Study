...
//        clazz=obj.getClass();
        String className="JAVAadvanced.Reflection.Entity.Student";
...
public void testClassLoader() throws ClassNotFoundException {
    ...
    classLoader=Class.forName( "JAVAadvanced.Reflection.Entity.Student" ).getClassLoader();
    System.out.println(classLoader);
    //测试object的类加载器，引导类
...
public void testClassLoader2(){
    InputStream in=null;
    in=this.getClass().getClassLoader().getResourceAsStream( "JAVAadvanced/Reflection/test.txt" );
