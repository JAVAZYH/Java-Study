package zyh.JAVAadvanced.Collection.Map;

import zyh.JAVAadvanced.Collection.Entity.Student;

import java.util.*;

//import java.util.zyh.Algorithm.Map.Entry;
...
//        zyh.Algorithm.Set<Integer> keys= map.keySet();//返回所有的key集合
...
//        zyh.JAVAadvanced.Collection<Student> values=map.values();
//        for (Student value:values){
//            System.out.println(value);
//        }

        //3.entrySet()获取所有的键值对集合，然后遍历所有的key-value键值对
        //zyh.Algorithm.Map.Entry是一个内部接口,可以直接导入也可以写为Map.Entry
       /*
       Set集合的泛型是Map.Entry类型，
       zyh.Algorithm.Map.Entry的泛型是Map集合的泛型
        */
