package zyh.JAVAadvanced.Collection.List;
...
//            test02();
//        test03();
//        zyh.Algorithm.List FileTest= CreateList();
...
//        zyh.Algorithm.List<String> list1=new java.util.ArrayList<>(  );
//        list.add( "123" );
//        list.add(  100);
//        list.add( 10.2 );
//
...
////           zyh.Algorithm.List<String> list2= Arrays.asList( arr );
